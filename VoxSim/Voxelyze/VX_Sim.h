...
struct SimState { //Information about current simulation state:
    void Clear() {CurCM = LastCM = TotalObjDisp = Vec3D<>(0,0,0);TotalObjTrajectoryLength = NormObjDisp = MaxVoxDisp = MaxVoxVel = MaxVoxKinE = MaxBondStrain = MaxBondStress = MaxBondStrainE = TotalObjKineticE = TotalObjStrainE = MaxPressure = MinPressure = 0.0;}
    Vec3D<> CurCM;
    Vec3D<> LastCM;
    ...
    vfloat TotalObjKineticE, TotalObjStrainE, TotalObjTrajectoryLength;
};
