...
namespace HCUBE
{
    ...
    {
        cout_ << "Creating Evaluation Panel...";
        // Create a memory DC
        wxMemoryDC temp_dc;
    ...
    void EvaluationPanel::setTarget(shared_ptr<Experiment> _experiment,shared_ptr<NEAT::GeneticIndividual> _individual)
    {
        if (bitmapLocked)
        {
            cout_ << "SETTING BACKUPINDIVIDUAL!\n";
        ...
        do
        {
            ...
            // Create a memory DC
            wxMemoryDC temp_dc;
            cout_ << GetSize().x << '/' << GetSize().y << endl;
    ...
    void EvaluationPanel::paint(wxPaintEvent& event)
    {
        ...
        {
            bitmapLocked=true;
            cout_ << "PAINTING BITMAP TO SCREEN!\n";
            wxPaintDC dc(this);
            ...
            {
                cout_ << "BITMAP IS NOT OK TO DRAW!\n";
            }
            bitmapLocked=false;
        }
    }
    ...
    {
        //cout_ << event.GetX() << ',' << event.GetY() << endl;
