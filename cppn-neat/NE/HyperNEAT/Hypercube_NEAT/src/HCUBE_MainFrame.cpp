...
namespace HCUBE
{
    ...
    void MainFrame::runExperiment(wxCommandEvent& WXUNUSED(event))
    {
        if (!experimentRun.isStarted())
        {
			...
			{
				cout_ << "Experiment is blocking GUI.  GUI will be "
						"unresponsive until experiment finishes\n";
				experimentRun.start();
			}
			else
			{
				cout_ << "Creating Boost Thread\n";
    ...
    cout_ << "Finished loading and ready to run!\n";
    }*/
