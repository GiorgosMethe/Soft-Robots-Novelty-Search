...
public:
    ...
    inline shared_ptr<GeneticIndividual> getIndividual(int a)
    {
        ...
        {
            cout_ << string("GENETICGENERATION::GETINDIVIDUAL: Individual index out of range!\n");
    ...
    NEAT_DLL_EXPORT  shared_ptr<GeneticIndividual> getGenerationChampionFitnessBackUp();
    /**
