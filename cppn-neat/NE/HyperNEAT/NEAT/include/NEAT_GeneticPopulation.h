...
namespace NEAT
{
    ...
    class GeneticPopulation
    {
        ...
        vector<shared_ptr<GeneticIndividual> > novelIndividuals;
    ...
    public:
        ...
        NEAT_DLL_EXPORT vector<shared_ptr<GeneticIndividual> > getNovelIndividuals()
        {
        ...
        NEAT_DLL_EXPORT shared_ptr<GeneticIndividual> getBestAllTimeIndividualFitnessBackUp();
    ...
    private:
        double getIndividualNovelty(shared_ptr<GeneticIndividual> individual, shared_ptr<GeneticGeneration> generation);
    };
