...
namespace NEAT
{
    ...
    void FastNetwork<Type>::setValue(const string &nodeName,Type newValue)
    {
        ...
        else
        {
            ...
            cout_ << nodeName << " is at index " << nodeNameToIndex[nodeName] << endl;
#endif
            nodeValues[it->second] = newValue;
#if DEBUG_NETWORK_UPDATE
            cout_ << nodeNameToIndex[nodeName] << " set to " << newValue << endl;
#endif
        }
    }
    ...
    void FastNetwork<Type>::updateFixedIterations(int iterations)
    {
        ...
        for (int a=0;a<count;a++)
        {
            ...
            for (int a=0;a<numLinks;a++)
            {
                ...
                cout_ << "From value: " << nodeValues[links[a].fromNode] << endl;
    ...
    void FastNetwork<Type>::print()
    {
        ...
        cout_ << sum << endl;
        cout_ << "DONE WITH FASTNETWORK SCREEN DUMP\n";
    }
